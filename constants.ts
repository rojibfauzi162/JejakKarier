...
export const INITIAL_DATA: AppData = Object.freeze({
  ...
  networkingRelations: ['Rekan (Peer)', 'Mentor', 'Atasan (Superior)', 'Klien (Client)', 'HR / Recruiter'],
  networkingFollowUpPlans: ['WhatsApp Segera', 'Kirim Email', 'Atur Jadwal Meeting', 'Tunggu Respon', 'Selesai / Terhubung'],
  networkingCompanies: [],
  networkingPositions: [],
  careerEvents: [],
