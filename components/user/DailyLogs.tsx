  ...
  return (
    <div className="space-y-4 md:space-y-8 animate-in slide-in-from-bottom duration-500 pb-20">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-3 md:p-6 lg:p-8 rounded-[2rem] lg:rounded-[2.5rem] text-white relative overflow-hidden shadow-xl shadow-blue-500/10">
        <div className="relative z-10 senior-header-content flex flex-col md:flex-row md:items-center justify-between gap-3 md:gap-6">
          <div>
                ...
                <div className="space-y-3 md:space-y-6">
                  {activityLines.map((line) => (
                    <div key={line.tempId} className={`p-4 md:p-8 lg:p-10 border rounded-[3rem] shadow-sm space-y-3 md:space-y-6 animate-in slide-in-from-top-4 relative group ${line.isPlan ? 'bg-white border-slate-100' : 'bg-emerald-50/10 border-emerald-100'}`}>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 pt-6 border-t border-slate-50">
                        {line.isPlan && (
                          <div className="md:col-span-4 space-y-2">
                            ...
                            <input 
                              ...
                              className="w-full px-4 py-3 md:px-6 md:py-4 rounded-2xl border border-slate-200 bg-white font-black text-sm focus:ring-4 focus:ring-blue-500/5 transition-all shadow-sm"
                              value={line.output || ''}
                        ...
                        <div className={`${line.isPlan ? 'md:col-span-4' : 'md:col-span-6'} space-y-2`}>
                          ...
                          <div className="flex gap-2">
                            <select 
                              className="flex-1 px-4 py-3 md:px-6 md:py-4 rounded-2xl border border-slate-200 bg-white font-black text-sm outline-none shadow-sm cursor-pointer"
